  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
      <div className="flex items-center space-x-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Profile & Sync</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Manage your profile and sync settings</p>
        </div>
      </div>
