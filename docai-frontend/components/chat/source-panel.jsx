...
export function SourcePanel({ sources: propSources = [], matchedPhrases = [] }) {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-gray-700 h-full overflow-hidden flex flex-col min-h-0">
      <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
        ...
        <p className="section-subtitle">Referenced content from your documents</p>
      </div>

      <div className="overflow-y-auto flex-1 p-4 min-h-0" style={{ scrollBehavior: 'smooth' }}>
        {sources.length === 0 ? (
